import { Calendar, Clock, ChevronLeft, Phone, ShieldCheck, AlertTriangle, Bug, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';
import SEO from '../components/SEO';

export default function PostTermiteSigns() {
  return (
    <div className="flex flex-col bg-white min-h-screen">
      <SEO 
        title="7 Warning Signs You Have Termites in Naples, FL — Expert Guide"
        description="Learn the most common signs of termite activity in Southwest Florida. Protect your Naples home from subterranean and drywood termites with our expert guide."
      />
      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex items-center justify-center gap-4 mb-6 uppercase font-black tracking-[0.3em] text-[10px]">
            <span className="text-white bg-white/10 px-4 py-1.5 rounded-full border border-white/20 uppercase tracking-[0.2em]">Termite Defense</span>
            <span className="text-white/60 flex items-center gap-2">
              <Calendar className="w-3 h-3" /> Oct 24, 2025
            </span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-medium text-white mb-8 tracking-tight leading-[1.1]">
            7 Warning Signs You Have Termites in Your <br/>
            <span className="italic font-bold underline decoration-white/20 underline-offset-8">Naples, FL Home</span>
          </h1>
      ...
      <section className="pb-32 px-8 max-w-4xl mx-auto leading-relaxed text-[#1A1A1A] space-y-8">
        <div className="prose prose-primary max-w-none">
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">1. Mud Tubes on Walls</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">2. Hollow Sounding Wood</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">3. Discarded Wings Near Windows</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">4. Bubbling or Uneven Paint</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">5. Tight Fitting Doors and Windows</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">6. Frass (Termite Droppings)</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#1A1A1A] font-bold mt-12 mb-6">7. Visible Termite Swarmers</h2>
          <p>
          ...
          <div className="mt-20 pt-12 border-t border-gray-100">
            <h3 className="text-3xl font-medium text-[#1A1A1A] mb-10">Frequently Asked Termite Questions in Naples</h3>
            <div className="space-y-8">
              <div>
                <h4 className="text-lg font-bold text-[#1A1A1A] mb-2">How often should I get a termite inspection in Naples?</h4>
              ...
              <div>
                <h4 className="text-lg font-bold text-[#1A1A1A] mb-2">Can Termites Survive the Naples Rainy Season?</h4>
              ...
              <div>
                <h4 className="text-lg font-bold text-[#1A1A1A] mb-2">What is the difference between Subterranean and Drywood termites?</h4>
          ...
          <div className="mt-20 pt-12 border-t border-gray-100 text-center">
            ...
            <h3 className="text-3xl font-medium text-[#1A1A1A] mb-6">Don't Wait for the Damage to Spread</h3>
